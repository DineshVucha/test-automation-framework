...
public class UISteps {
    ...
    public void setBrowserType(String browser) {
        logger.info("Browser is : " + configvariable.expandValue(browser));
        scenarioUtils.write("Browser is : " + configvariable.expandValue(browser));
        configvariable.setStringVariable(configvariable.expandValue(browser), "web.browser.type");
    }

    @Given("^I open browser in hidden mode \"([^\"]*)\"$")
    public void setBrowserMode(String browserMode) {
        logger.info("Browser mode is : " + configvariable.expandValue(browserMode));
        scenarioUtils.write("Browser mode is : " + configvariable.expandValue(browserMode));
        configvariable.setStringVariable(configvariable.expandValue(browserMode), "web.driver.headless");
    }

    @Given("^I set default download directory as \"([^\"]*)\"$")
    public void setDefaultDownloadDir(String downloadDir) {
        logger.info("Download directory is : " + configvariable.expandValue(downloadDir));
        scenarioUtils.write("Download directory is : " + configvariable.expandValue(downloadDir));
        configvariable.setStringVariable(configvariable.expandValue(downloadDir), "web.browser.download");
    }
    ...
    public void launchBrowserApplication(String url) throws InterruptedException {
        scenarioUtils.write("Web url is " + configvariable.expandValue(url));
        uiBasePage.launchApp(configvariable.expandValue(url), "", "");
        Thread.sleep(5000);
    }
    ...
    public void launchBrowserApplication(String url, String userName, String password) {
        scenarioUtils.write("Web url is " + configvariable.expandValue(url));
        uiBasePage.launchApp(configvariable.expandValue(url), configvariable.expandValue(userName), configvariable.expandValue(password));
    }
    ...
    public void setBrowserCookie(String cookieName, String cookieValue, String domain) {
        logger.info("Cookie name is : " + configvariable.expandValue(cookieName));
        logger.info("Cookie value is : " + configvariable.expandValue(cookieValue));
        logger.info("Cookie domain is : " + configvariable.expandValue(domain));
        scenarioUtils.write("Cookie name is : " + configvariable.expandValue(cookieName));
        scenarioUtils.write("Cookie value is : " + configvariable.expandValue(cookieValue));
        scenarioUtils.write("Cookie domain is : " + configvariable.expandValue(domain));
    ...
    public void deleteBrowserCookie(String cookieName) throws InterruptedException {
        scenarioUtils.write("Deleting Cookie : " + configvariable.expandValue(cookieName));
    ...
    public void navigateToURL(String url) {
        scenarioUtils.write("Navigate url : " + configvariable.expandValue(url));
